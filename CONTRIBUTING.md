...
RustUse/use-units is intentionally small and focused. Contributions should keep the public API explicit, typed, and pragmatic.
...
- `use-units` is the RustUse units primitives crate, not a CLI and not a general automation layer.
